...
function multiply(a,b){
  var multNum = a * b;
  var multMessage = 'The product of ' + a + ' and ' + b + ' is ' + multNum + '.';
  return [multNum, multMessage];
}
multiply(5,9);
...
function sumAndMultiply(a,b,c){
  var multNum = multiply(a,b);
  var multProduct = multNum[0] * c;
  //console.log('multNum', multProduct);
  var addNum = sum(a,b);
  var addSum = addNum[0] + c;
  //console.log('addSum', addSum);
  var addMessage = a + ' and ' + b + ' and ' + c + ' sum to ' + addSum + '.';
  var multMessage = 'The product of ' + a + ' and ' + b + ' and ' + c + ' is ' + multProduct + '.';
  return [addSum, multProduct, addMessage, multMessage];
}
...
and then returns an array where the first element is the sum of the numbers in the array, and the second element is a string that EXACTLY follows this example and concatenates a message using the arguments that were passed into the function:
...
function sumArray(testArray){
  ...
  var messageOne = testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' was passed in as an array of numbers, and ' + sumTwo[0] + ' is their sum.';
  //return [sumTwo[0], messageOne];
  //alert(messageOne);
...
function multiplyArray(testArray){
  ...
  //console.log(testArray[1]);
  //console.log(testArray[2]);
  var messageTwo = 'The numbers ' + testArray[0] + ',' + testArray[1] + ',' + testArray[2] + ' have a product of ' + productTwo[0] + '.';
  //return [sumTwo[0], messageOne];
  //alert(messageOne);
  //console.log(messageTwo);
  return [productTwo[0],messageTwo];
